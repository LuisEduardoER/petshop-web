...
public class Constants {
	...
	public static final int KV_INTERVAL_TIME_CITA= 30;
	
	public static final Calendar KV_TODAY = Calendar.getInstance();
		
	public static final int KV_TURN_MORNING_INI = 9;
	public static final int KV_TURN_MORNING_FIN = 13;
	
	public static final int KV_TURN_EVENING_INI = 14;
	public static final int KV_TURN_EVENING_FIN = 18;
