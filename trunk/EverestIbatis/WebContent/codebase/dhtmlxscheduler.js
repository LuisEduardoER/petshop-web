...
scheduler.locale = {
		date: {
			...
			day_full: ["Domingo", "Lunes", "Martes", "Mi&eacute;rcoles", "Jueves", "Viernes", "S&aacute;bado"],
		...
		labels: { 
			...
			confirm_closing: "Sus cambios se perder&aacute;n,¿Co&aacute;tinuar?", //"Sus cambios se perderÃ¡n, continuar ?"
			confirm_deleting: "El evento se borrar&aacute; definitivamente, ¿Continuar?",
			section_description: "Descripci&oacute;n",
			section_time: "Periodo de tiempo",
			full_day: "Todo el d&iacute;a",
