...
public class CitaDisponibilidadAction extends ActionSupport{
	
	private static final long serialVersionUID = 4637693879853953827L;
	...
	DateFormat minuteFormat 	= new SimpleDateFormat ("mm:ss");
